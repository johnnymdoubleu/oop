...
public class CreditCardTest {
    ...
    public void setUp() {
        ...
        creditCardExpired = new CreditCard(10, 2014, "Bob", "Jones", "1234567890123456"); // expired!
    ...
    public void testFormatExpiryDate() {
        assertEquals("10/14", creditCardExpired.formatExpiryDate());
    ...
    public void testToString() {
        String expected = 
            ...
            "Is valid: false";
        assertEquals(expected, convertToUnix(creditCardExpired.toString()));
        ...
        expected = 
            ...
            "Is valid: true";
        assertEquals(expected, convertToUnix(creditCardNextYear.toString()));
    }
